...
public class Battleship {
    ...
    public static void main(String[] args) {
        ...
        boolean error = false; //Speicher fÃ¼r falsche Eingabe, wenn Spieler falsche Eingabe tÃ¤tigt wird der Wert auf "true" gestellt.
        ...
        do {
            ...
            if (amountOfPlayer < 2 || amountOfPlayer > 6) {//PrÃ¼fen ob Spieler kleiner 2 oder grÃ¶ÃŸer 6 ist, wenn ja wird error auf true gestellt.
                error = true;
     ...
     * @param opponent Integerwert des Gegners fï¿½r das Finden im Array
